...
def shoe_size(name)
    find_shoe = players.find do |player|
    player.fetch(:player_name) == name
end
...
def team_colors(team_name)
    find_team = team_stats.find do |team|
...
def player_numbers(team_name)
    find_number = team_stats.find do |team|
    team.fetch(:team_name) == team_name
end
    find_number[:players].collect do |player|
    player[:number]
end
end
...
def player_stats(name)
    ...
    stats.delete_if do |info, string|
    info == :player_name
end
end
...
def big_shoe_rebounds
    big_shoe = players.max_by do |player_shoe|
    player_shoe.fetch(:shoe)
end
